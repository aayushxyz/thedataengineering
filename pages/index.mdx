...
{/*<h1 style={{"textAlign": "center", "fontSize": 36, "fontWeight": "bold",marginTop: "20px"}}>
  <Balancer>Data is the new Science.<br/>Data Engineering is the Foundation.</ Balancer>
</h1>*/}
<h1 style={{"textAlign": "center", "fontSize": 36, "fontWeight": "bold",marginTop: "20px"}}>
  <Balancer>Advance Your Data Engineering Career</ Balancer>
</h1>

<h2 style={{"textAlign": "center", "fontSize": 20, "fontWeight": "normal",marginTop: "15px"}}>
  <Balancer>From basic concepts to advanced tools and techniques, we provide the resources to help you design, build, and scale data systems that drives business.</Balancer>
</h2>
